...
console.log("Your new total is: $", calculateTotal(0, 100)); // returns 100
console.log("Your new total is: $", calculateTotal(1, 100)); // returns 50
console.log("Your new total is: $", calculateTotal(2, 100)); // returns 0)
console.log("Your new total is: $", calculateTotal(3, 100)); // returns 0)
console.log("Your new total is: $", calculateTotal(4, 100)); // returns 0)
console.log("Your new total is: $", calculateTotal(5, 100)); // returns 0)
/**
 * TODO:
...
// Generate a random number between 0 and 6
 ...
 var parsedNumber = prompt("What is your bill total?");
...
var add100 = parseInt(numberEntered +100);
if (numberEntered % 2 === 0){
    alert("The number you entered is even.");
}else if(numberEntered % 2 !== 0){
    alert("The number you entered is odd.");
}else if(numberEntered + add100){
    alert("The new sum is: " + add100);
}else if(numberEntered > 0){
    alert("This number positive")
}else if(numberEntered < 0){
    alert("This number is negative");
}else if (numberEntered === isNaN){
