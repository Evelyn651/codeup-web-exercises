...
/**
 * TODO:
 * Call the function 'sayHello' and pass your name as a string literal argument. Store the result of the function call in a variable named 'helloMessage'. console.log 'helloMessage' to check your work
 */
console.log(sayHello("Michael"));
console.log(sayHello("Casey"));
...
/**
 * TODO:
 * Create a function named 'calculateTip' to calculate a tip on a bill at a restaurant. The function should accept a tip percentage and the total of the bill, and return the amount to tip
 *
 * Examples:
 ...
 * prompt the user for the bill total and a percentage they would like to tip, then display the dollar amount they should tip
 */
...
/**
 * TODO:
 * Create a function named `applyDiscount`. This function should accept a price (before a discount is applied), and a discount percentage (a number between 0 and 1). It should return the result of applying the discount to the original price.
 *
 * Example:
