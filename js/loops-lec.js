...
while(i < 10){
    ...
    i++;
    //i = i + 1; the above is shorthand for this.
}
...
while (i <= 20){
    console.log('Count up to 20 in 2s', i);
...
for(var i = 0; i <= 5; i++){
    console.log('numbers 0-5 (inclusive): ' + i);
}
...
for(var i = 0; i <= 100; i++){
    if(i % 2 === 0){
        console.log('Logging all numbers between 0 and 100: ' + i);
     } //else{
    //     console.log('Logging all numbers between 0 and 100:   ' + i);
    // }
}
...
for(var i = 0; i <= 100; i += 2){
    console.log('Logging all numbers between 0 and 100 again: ' + i);
}
...
for(var i = 0; i <= 100; i++){
    if(i % 5 === 0) {
        console.log('numbers 0-100 divisible by 5: ' + i);
    }
}
...
// Using a for loop to get the first 5 even numbers when counting from 0 to 100.
